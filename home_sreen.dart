    ...
    return Scaffold(
      ...
      children: [
        ...
        Positioned(
          top: 80,
            left: 20,
            child: Text("Pokedex", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Colors.black),)),
        Positioned(
          top: 150,
          bottom: 0,
          width: width,
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: type == 'Grass' ? Colors.greenAccent :  type == "Fire" ? Colors.redAccent : type == "Water" ? Colors.lightBlue : type == "Electric" ? Colors.yellowAccent
                                  ...
                                  : type == "Ghost"? Colors.deepPurple : type == "Normal" ? Colors.black26 : type == "Poison"? Colors.deepPurpleAccent : Colors.pinkAccent,
                                  borderRadius:
